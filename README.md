...
[![Build Status](https://travis-ci.org/hoveychen/protoreflect.svg?branch=master)](https://travis-ci.org/hoveychen/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/hoveychen/protoreflect)](https://goreportcard.com/report/github.com/hoveychen/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/hoveychen/protoreflect?status.svg)](https://godoc.org/github.com/hoveychen/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/hoveychen/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/desc)*

```go
import "github.com/hoveychen/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/desc/protoparse)*

```go
import "github.com/hoveychen/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/desc/protoprint)*

```go
import "github.com/hoveychen/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/hoveychen/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/dynamic)*

```go
import "github.com/hoveychen/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/hoveychen/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/hoveychen/protoreflect/grpcreflect)*
